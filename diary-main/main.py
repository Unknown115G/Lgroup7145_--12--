...
class User(db.Model):
    ...
    title = db.Column(db.String(100), primary_key=True, autoincrement=True, nullable=False)
    subtitle = db.Column(db.String(100), primary_key=True, autoincrement=True, nullable=False)
    text = db.Column(db.Text, primary_key=True, autoincrement=True, nullable=False)
